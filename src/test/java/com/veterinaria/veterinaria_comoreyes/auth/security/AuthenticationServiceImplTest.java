...
import com.veterinaria.veterinaria_comoreyes.config.JwtAuthFilter;
...
public class AuthenticationServiceImplTest {
    ...
    // Nuevo test simulado con cookie jwtToken para filtro (simulación integrada aquí)
    @Test
    @DisplayName("Simulación de filtro con jwtToken en cookie")
    void testJwtCookieTokenFilterSimulation() throws IOException, ServletException {
        ...
        when(jwtUtil.getEmailFromJwt("valid.jwt.token")).thenReturn("user@correo.com");
        when(jwtUtil.getAuthoritiesFromJwt("valid.jwt.token")).thenReturn(List.of());

        new JwtAuthFilter(jwtUtil).doFilterInternal(request, response, (req, res) -> {});
